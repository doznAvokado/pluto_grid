...
class PlutoGridShortcut {
  ...
  static final Map<ShortcutActivator, PlutoGridShortcutAction> defaultActions = {
    ...
    ///TODO: 0822 dwk added. (소문자 c)
    LogicalKeySet(LogicalKeyboardKey.control, const LogicalKeyboardKey(0x0000000043)):
        const PlutoGridActionCopyValues(),

    ///TODO: 0822 dwk added. (한글 ㅊ)
    LogicalKeySet(LogicalKeyboardKey.control, const LogicalKeyboardKey(12618)): const PlutoGridActionCopyValues(),
    ...
    ///TODO: 0822 dwk added. (소문자 v)
    LogicalKeySet(LogicalKeyboardKey.control, const LogicalKeyboardKey(0x0000000056)):
        const PlutoGridActionPasteValues(),

    ///TODO: 0822 dwk added. (한글 ㅍ)
    LogicalKeySet(LogicalKeyboardKey.control, const LogicalKeyboardKey(12621)): const PlutoGridActionPasteValues(),
