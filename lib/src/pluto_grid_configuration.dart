...
class PlutoGridStyleConfig {
  const PlutoGridStyleConfig({
    ...
    this.inactivatedCellColor = const Color(0xFFC4C7CC),
  ...
  const PlutoGridStyleConfig.dark({
    ...
    this.inactivatedCellColor = const Color(0xFF666666),
    this.wrongCellColor = const Color(0xFFFF4E4E),
    this.separateBottomBorderSide = BorderSide.none,
    this.iconSize = 18,
    this.rowHeight = PlutoGridSettings.rowHeight,
  ...
  PlutoGridStyleConfig copyWith({
    ...
    return PlutoGridStyleConfig(
      ...
      inactivatedCellColor: inactivatedCellColor ?? this.inactivatedCellColor,
  ...
  bool operator ==(covariant Object other) {
    return identical(this, other) ||
        other is PlutoGridStyleConfig &&
            ...
            inactivatedCellColor == other.inactivatedCellColor &&
